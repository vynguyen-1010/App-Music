package com.fhm.musicr.ui.nowplaying;
...
import com.fhm.musicr.ui.LayerController;

import com.fhm.musicr.ui.MainActivity;
import com.fhm.musicr.ui.bottomsheet.OptionBottomSheet;
import com.fhm.musicr.ui.widget.view.AudioVisualSeekBar;
import com.fhm.musicr.util.SortOrder;
...
/*
    ...
    */
    ...
    public boolean onGestureDetected(int gesture) {
        ...
        if(gesture==LayerController.SINGLE_TAP_UP) MusicPlayerRemote.playOrPause();
...
//                return true;
//            }
        else if(gesture==LayerController.SWIPE_LEFT && !isTouchedVisualSeekbar) MusicPlayerRemote.playNextSong();
        else if(gesture==LayerController.SWIPE_RIGHT && !isTouchedVisualSeekbar) MusicPlayerRemote.playPreviousSong();
