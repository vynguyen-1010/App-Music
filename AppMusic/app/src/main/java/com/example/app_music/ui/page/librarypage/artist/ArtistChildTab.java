...
import com.fhm.musicr.loader.medialoader.ArtistLoader;
import com.fhm.musicr.loader.medialoader.PlaylistLoader;
import com.fhm.musicr.model.Artist;
import com.fhm.musicr.model.Genre;
import com.fhm.musicr.ui.page.BaseMusicServiceFragment;
import com.fhm.musicr.ui.page.librarypage.song.SongSearchEvent;
import com.fhm.musicr.ui.page.subpages.ArtistPagerFragment;
...
//        refresh();
    ...
    private void refreshData(String search) {
        if(getActivity() !=null){
            mAdapter.setData(ArtistLoader.getArtists(getActivity(), search));
...
//    getArtists
  ...
  /*      SupportFragment sf = ArtistTrialPager.newInstance(artist);*/
    ...
    public void onMessageEvent(ArtistSearchEvent event) {
        refreshData(""+event.getMessage());
    };
}
